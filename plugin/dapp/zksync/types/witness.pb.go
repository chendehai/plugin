...
type ZkSpotTradeWitnessInfo struct {
	...
	//交易费率
	TakerFeeRate string       `protobuf:"bytes,6,opt,name=takerFeeRate,proto3" json:"takerFeeRate,omitempty"`
	MakerFeeRate string       `protobuf:"bytes,7,opt,name=makerFeeRate,proto3" json:"makerFeeRate,omitempty"`
...
func (x *ZkSpotTradeWitnessInfo) GetPrice() string {
	if x != nil {
		return x.Price
	}
	return ""
...
func (x *ZkSpotTradeWitnessInfo) GetTakerFeeRate() string {
	if x != nil {
...
func (x *ZkSpotTradeWitnessInfo) GetMakerFeeRate() string {
	if x != nil {
...
var file_witness_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x12, 0x22, 0x0a, 0x0c, 0x74, 0x61, 0x6b, 0x65,
	0x72, 0x46, 0x65, 0x65, 0x52, 0x61, 0x74, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c,
